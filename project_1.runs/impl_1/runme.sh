...
HD_PWD='E:/Semester 2/Computer Organization and Digital Design/Lab/FinalProject/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OurProcessor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OurProcessor.tcl -notrace
