...
HD_PWD='E:/Semester 2/Computer Organization and Digital Design/Lab/FinalProject/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OurProcessor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OurProcessor.tcl
